...
public class CadastroClienteView extends JFrame {
	...
	public CadastroClienteView() throws ParseException {
		...
		label_1 = new JLabel("");
		label_1.setIcon(new ImageIcon(CadastroClienteView.class.getResource("/images/logo.png")));
		...
		label.setIcon(new ImageIcon(CadastroClienteView.class.getResource("/images/Login.png")));
